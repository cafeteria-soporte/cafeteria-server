...
export class ErrorResponseDto {
  ...
  @ApiProperty({
    description:
      'Código de error machine-readable. Los domain errors usan SCREAMING_SNAKE_CASE.',
    example: 'NOT_FOUND',
    examples: {
      generic: { value: 'NOT_FOUND', summary: 'Error genérico de NestJS' },
      domain: {
        value: 'USER_NOT_FOUND',
        summary: 'Error de dominio específico',
      },
  ...
  @ApiProperty({
    description:
      'Mensaje legible para el usuario o lista de errores de validación',
    oneOf: [
