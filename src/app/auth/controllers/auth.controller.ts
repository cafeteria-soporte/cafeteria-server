...
export class AuthController {
  ...
  @ApiOperation({
    ...
    description:
      'Solo administradores y root. El usuario se crea con requires_pwd_change = true.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'El usuario cambia su propia contraseña. Después del cambio requires_pwd_change queda en false.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'El accessToken expira por sí solo. Requiere Authorization: Bearer <token>.',
  })
