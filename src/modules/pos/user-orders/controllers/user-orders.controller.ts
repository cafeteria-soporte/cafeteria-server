...
export class UserOrdersController {
    ...
    findAll(@Query() pagination: PaginationParamsDto): Promise<PaginationResponseDto<UserOrderDto>> {
    ...
    @ApiOperation({
        ...
        description: 'Valida suma de pagos, genera receipt_number, crea stock_movements de salida y marca la orden como paid. Todo en una transacción.',
    })
    @ApiOkResponse({ type: UserOrderDto })
    pay(
    ...
    @ApiOperation({
        ...
        description: 'Solo se pueden anular órdenes con status paid. Crea stock_movements de tipo sale_void para revertir el stock.',
    })
    @ApiOkResponse({ type: UserOrderDto })
    void(
        @Param('id', ParseIntPipe) id: number,
