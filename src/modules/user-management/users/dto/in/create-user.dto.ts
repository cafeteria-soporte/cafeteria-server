...
import { IsString, IsNotEmpty, MaxLength, IsEmail, MinLength, IsInt, IsIn, IsOptional } from 'class-validator';
...
export class CreateUserDto {
    ...
    @IsIn([RolesEnum.ADMINISTRATOR, RolesEnum.CASHIER], { message: 'Role ID must be 2 (administrator) or 3 (cashier).' })
    roleId: number;
}
