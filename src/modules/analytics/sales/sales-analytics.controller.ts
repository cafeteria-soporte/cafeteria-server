...
export class SalesAnalyticsController {
  ...
  @ApiOperation({
    ...
    description:
      'Agrupa las ventas pagadas por día, semana o mes según el parámetro groupBy.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Ingresos, número de órdenes y porcentaje por cada categoría de producto.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Ranking de productos ordenados por ingresos totales. Usa ?limit para controlar cuántos devuelve.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Descarga el reporte completo de ventas en PDF o CSV. Usa ?format=pdf o ?format=csv.',
  })
