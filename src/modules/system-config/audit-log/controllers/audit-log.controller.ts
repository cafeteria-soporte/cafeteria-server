...
export class AuditLogController {
    ...
    @ApiOperation({
        ...
        description: 'Solo root. Devuelve todos los eventos auditados con filtros y paginación.',
    })
    @ApiOkResponse({ type: FindAllAuditLogsResponseDto })
    async findAll(@Query() params: FindAuditLogsDto): Promise<FindAllAuditLogsResponseDto> {
