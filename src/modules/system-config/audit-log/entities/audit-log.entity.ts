...
export class AuditLog extends BaseCreated {
    ...
    @Column({ name: 'username_snapshot', type: 'varchar', length: 50, nullable: true })
    usernameSnapshot: string | null;

    @Column({ name: 'role_snapshot', type: 'varchar', length: 50, nullable: true })
    ...
    @Column({ name: 'affected_entity', type: 'varchar', length: 100, nullable: true })
