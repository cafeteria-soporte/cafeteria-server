...
export class StockMovementsController {
    ...
    @ApiOperation({
        ...
        description: 'Tipos válidos: goods_receipt (1), manual_adjustment (2), shrinkage (3). Los tipos sale y sale_void se crean automáticamente al pagar/anular una orden.',
    })
    @ApiCreatedResponse({ description: 'Movimiento registrado correctamente.' })
    async create(@Body() dto: CreateStockMovementDto, @CurrentUser() user: AuthUser) {
